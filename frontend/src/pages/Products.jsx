        ...
        <Layout>
            <div className="max-w-6xl mx-auto p-4">
                ...
                <div className="bg-white rounded-lg shadow-sm border p-6 sm:p-8 text-center">
                    <Package className="mx-auto h-12 sm:h-16 w-12 sm:w-16 text-blue-600 mb-4" />
                    <h2 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2">
                        Product Management Module
                    </h2>
                    <p className="text-gray-600 mb-4 text-sm sm:text-base">
                        This module will include category management, product forms, product listing, editing, and removal functionality.
                    </p>
